...
import { doctorAPI, receptionistAPI } from "../../utils/api";
...
const DoctorPanel = () => {
  ...
  const parseWorkingHours = (wh) => {
    ...
    // Accept both 24h and 12h (AM/PM) formats, with optional days
    // Examples: "Monday, Tuesday 09:00 - 17:00" or "10:15 PM - 10:15 PM"
    ...
    if (match) {
      ...
      // Try time-only string without days
    ...
    <div className="doctor-section">
      <div className="section-header">
        <div className="section-title">
          ...
          <div className="section-stats section-stats-inline">
          </div>
        </div>
      </div>
                    ...
                    <div className="detail-stack">
                      <div className="detail-item">
                        ...
                        <div className="detail-content">
                          ...
                          <span className="detail-value">
                            {selectedItem.dateOfBirth || "Not provided"}
                          </span>
                        </div>
                      </div>
