...
const ReceptionistNotifications = () => {
  ...
  // Build notifications for patients registered on selected day
  (patients || []).forEach((p) => {
  ...
  // Build notifications for appointments created on selected day
  ...
  // Sort notifications in ascending chronological order
    ...
    <div className="receptionist-notifications table-card">
      <div className="table-header">
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          {/* Date filter: controls which day's notifications are shown */}
          <input
            type="date"
            value={selectedDate}
              ...
              <tr>
                <td colSpan={3} className="no-data">
                  <div className="no-data-content">
                    ...
                    {/* Empty state when no notifications match the selected date */}
