...
import { EditProfileModal } from "../ui/EditButton/EditButton";
...
//Edit Profile Modal
export const EditProfileLayer = () => {
  // Modal and profile state from context
  const {
    showModal,
    modalType,
    error,
  ...
  // Show modal only if correct modal type
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="form-group">
        ...
        <input
          name="insurance"
          className="form-control"
          placeholder="Enter insurance provider or policy"
      ...
      <div className="form-group">
        ...
        <textarea
          ...
          placeholder="Describe medical history (conditions, surgeries, notes)"
      ...
      <div className="form-group">
        ...
        <textarea
          ...
          className="form-control form-textarea"
          placeholder="List permanent or ongoing medicines"
